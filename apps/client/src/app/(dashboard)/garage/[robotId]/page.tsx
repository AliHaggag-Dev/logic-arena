        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                className={
                  isMobile ? "pb-2" : "border-b border-accent/10 pb-5"
                }
              >
                <ColorPicker
                  selected={color}
              ...
              {/* Mobile: visual link between picker and sticky footer */}
              {isMobile && (
