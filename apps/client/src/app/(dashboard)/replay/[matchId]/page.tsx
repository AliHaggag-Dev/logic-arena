          ...
          <div className="mb-5 md:mb-8 border-b border-accent/20 pb-4 md:pb-6">
            <div className="flex flex-col gap-3 md:gap-4">
              <button
                type="button"
                onClick={() => router.back()}
                className="w-max bg-transparent border border-accent/15 rounded px-2.5 py-1 md:px-3 hover:border-accent/40
                hover:bg-accent/20 text-accent/70 cursor-pointer text-[9px] md:text-[10px] tracking-[0.25em] font-mono flex items-center gap-1.5 transition-all duration-200 uppercase"
              >
