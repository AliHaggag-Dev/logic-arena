...
export function LevelModal({ modal, setModal, reward, stars, level, isMobile, router }: LevelModalProps) {
  ...
  return (
    <div className={`fixed inset-0 z-50 flex bg-bg-primary/85 backdrop-blur-md ${isMobile ? "items-stretch justify-center p-0" : "items-center justify-center px-4"}`} role="dialog" aria-modal="true">
      {modal === "victory" && (
        <VictoryScreen
          reward={reward}
          stars={stars}
