...
export function LeaderboardClient({
  ...
  // Initialise with SSR data — no skeleton on first render
  ...
  const { joinLeaderboard, leaveLeaderboard, emitSpectate } =
    useGlobalSocket(socketHandlers);
        ...
        <div className="max-w-5xl mx-auto pt-16 px-6 relative z-20">
          ...
          <div className="mt-8 flex justify-center opacity-30">
            <div className="flex gap-4 items-center">
              ...
              <div
                className="w-2 h-2 border border-accent rotate-45 animate-pulse"
