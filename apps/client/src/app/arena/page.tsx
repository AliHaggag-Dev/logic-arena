...
const ArenaPage = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden font-mono select-none">
      ...
      <div className="absolute top-24 left-8 z-20 flex flex-col gap-2">
        {/* Respawn */}
        <button
          type="button"
        ...
        >
          ...
          <div className="absolute inset-0 bg-red-500/5 blur-sm group-hover:blur-md transition-all" />
        </button>
        ...
        <button
          ...
          className={`group relative border text-[10px] font-black px-6 py-2 transition-all tracking-[0.2em] ${
            fogEnabled
              ? 'border-cyan-600/60 bg-cyan-950/20 text-cyan-400 hover:bg-cyan-500/20 hover:border-cyan-400'
              : 'border-white/20   bg-white/5       text-white/40   hover:bg-white/10    hover:border-white/40'
          }`}
        >
          ...
          {fogEnabled && (
            <div className="absolute inset-0 bg-cyan-500/5 blur-sm group-hover:blur-md transition-all" />
          )}
        </button>
      </div>
