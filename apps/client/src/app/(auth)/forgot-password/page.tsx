    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-bg-primary font-mono selection:bg-accent/30 relative overflow-hidden p-4 pt-16 sm:p-6 sm:pt-20">
        ...
        <div className={`w-full max-w-[420px] bg-card/60 backdrop-blur-xl border border-accent/20 rounded-xl ${isMobile ? "p-6" : "p-8"} relative z-20 shadow-[0_0_50px_rgba(0,0,0,0.8),inset_0_0_20px_rgba(var(--accent-rgb),0.05)] animate-[fadeInScale_0.4s_ease-out] ${isMobile ? "shadow-[inset_3px_0_0_0_var(--color-red-500)]" : ""}`}>
          ...
          <div className="absolute top-3 right-4 text-[9px] text-red-500/30 tracking-[0.2em] pointer-events-none">v1.0</div>
          ...
          <form onSubmit={handleForgot} className="flex flex-col gap-6">
            <div className="flex flex-col gap-2 relative">
              ...
              <input
                type="email"
                id="email"
                className={`w-full bg-bg-primary/80 border border-red-500/20 rounded-lg ${isMobile ? "p-4" : "p-3.5"} text-red-500 outline-none focus:border-red-500/60 focus:bg-red-500/5 transition-all shadow-[inset_0_2px_10px_rgba(0,0,0,0.5)] text-xs placeholder:opacity-60 focus:shadow-[0_0_20px_rgba(var(--color-red-500),0.1)]`}
