...
export function AuthSocials({ isMobile: _isMobile }: Props) {
  const btnClass = [
    ...
    <>
      <div className="flex flex-col gap-3 mb-6">
        <a
          ...
          onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.background = 'color-mix(in srgb, var(--text-primary) 4%, transparent)'; }}
        >
        ...
        <a
          ...
          onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.background = 'color-mix(in srgb, var(--text-primary) 4%, transparent)'; }}
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="text-text-primary" aria-hidden="true">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-xs text-text-secondary tracking-wider">or</span>
        <div className="flex-1 h-px" style={{ background: 'rgba(var(--accent-rgb),0.12)' }} />
      </div>
    </>
  );
