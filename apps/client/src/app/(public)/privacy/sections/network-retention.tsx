      ...
      <PublicSectionCard id="data-retention" index={6} title="Data Retention" icon={<Database size={16} />}>
        <div className="flex flex-col gap-4">
          ...
          <div className="rounded-xl overflow-hidden" style={{ border: "1px solid rgba(var(--accent-rgb), 0.12)" }}>
            ...
            <PublicDefinition term="Practice vs AI Rewards">Authenticated Practice vs AI rewards may be retained with your profile and match history. Guest AI/session summaries and solo tests without a difficulty flag are temporary and do not create persistent point records.</PublicDefinition>
