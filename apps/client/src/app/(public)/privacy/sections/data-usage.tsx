    ...
    <>
      <PublicSectionCard id="information-we-collect" index={1} title="Information We Collect" icon={<Database size={16} />}>
        <div className="flex flex-col gap-5">
          <PublicBody>When you create a Logic Arena account, we collect the minimum data required to operate a competitive multiplayer platform. This falls into two categories:</PublicBody>
