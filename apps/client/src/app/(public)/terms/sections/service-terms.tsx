      ...
      <PublicSectionCard id="termination" index={9} title="Termination" icon={<Zap size={16} />}>
        <div className="flex flex-col gap-4">
          ...
          {[
            ...
            "Your AliScript programs, match history, ELO data, Practice vs AI reward records, and persisted arena replay records will be deleted or anonymised where required, and may be retained in aggregate or anonymised form for integrity and historical replay purposes.",
